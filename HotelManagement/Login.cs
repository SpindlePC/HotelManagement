    ...
    public partial class Login : MetroForm
    {
        ...
        private void signinButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MetroFramework.MetroMessageBox.Show(this, "Błedny login lub hasło", "", MessageBoxButtons.RetryCancel, MessageBoxIcon.Error);
                }
            }
            catch (Exception ex)
            {
                MetroFramework.MetroMessageBox.Show(this, ex.ToString(), "Błąd", MessageBoxButtons.RetryCancel, MessageBoxIcon.Error);
            }
        }
