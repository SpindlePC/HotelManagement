...
namespace Hotel_Manager
{
    public partial class Frontend : MetroForm
    {
        ...
        public void foodMenuButton_Click(object sender, EventArgs e)
        {
            ...
            cleaning = food_menu.Cleaning.Replace(" ", string.Empty) == "Sprzatanie codzienne" ? "1" : "0";
            towel = food_menu.Towel.Replace(" ", string.Empty) == "Wymiana recznikow" ? "1" : "0";

            surprise = food_menu.Surprise.Replace(" ", string.Empty) == "Inwalida" ? "1" : "0";
        ...
        private void submitButton_Click(object sender, EventArgs e)
        {
            ...
            string query = "insert into reservation(first_name, last_name, birth_day, gender, phone_number, email_address, number_guest, street_address, apt_suite,city, state, zip_code, room_type, room_floor, room_number, total_bill,payment_type, card_type, card_number,card_exp,card_cvc, arrival_time, leaving_time, check_in, break_fast, lunch, dinner, supply_status, cleaning, towel, s_surprise, food_bill) values('" + firstNameTextBox.Text +
              ...
              "', '" + roomNComboBox.SelectedItem + "', '" + "', '" + paymentType +
        ...
        private void updateButton_Click(object sender, EventArgs e)
        {
            ...
            string query = "update reservation set first_name ='" + firstNameTextBox.Text +
              ...
              "', room_number='" + roomNComboBox.SelectedItem + "', total_bill='" +
            ...
            try
            {
                ...
                " " + userID, "RAPORT", MessageBoxButtons.OK, MessageBoxIcon.Question);
                while (reader.Read())
                {
        ...
        private void LoadForDataGridView()
        {
            ...
            {
                MetroFramework.MetroMessageBox.Show(this, "Błąd pobierania danych", "Błąd", MessageBoxButtons.RetryCancel, MessageBoxIcon.None);
            }
        }
        ...
        {
            RecvPhoneNumber = "+48" + phoneNumberTextBox.Text.Replace(" ", string.Empty);
            long getphn = Convert.ToInt64(phoneNumberTextBox.Text);
            string formatString = String.Format("{0:000000000}", getphn);
        ...
        private void searchButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SearchError.Text = "UPS :(" + "\n"
                    + "Niestety nie znaleziono wyników pod nazwą " + searchTextBox.Text + "\n"
                + "Spróbuj wprowadzić inną wartość";
            }
        }
