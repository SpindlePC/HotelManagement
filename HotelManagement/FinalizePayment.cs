...
namespace Hotel_Manager
{
    public partial class FinalizePayment : MetroForm
    {
        ...
        private void FinalizePayment_Load(object sender, EventArgs e)
        {
            ...
            currentBillAmount.Text = "$" + Convert.ToString(totalAmountFromFrontend)+"";
            foodBillAmount.Text = "$" + Convert.ToString(foodBill) + "";
            taxAmount.Text = "$" + Convert.ToString(totalWithTax)+"";
            totalAmount.Text = "$" + Convert.ToString(FinalTotal) + "";
